...
function renderAccas(){
  ...
  sections.forEach(sec=>{
    ...
    rows.forEach(a=>{
      ...
      btnRow.className = "trackBtnRow";
      right.appendChild(btnRow);

      btnRow.appendChild(mkBtn("✅", "win", ()=>setAccaStatus(a.id,"won")));
      btnRow.appendChild(mkBtn("❌", "lose", ()=>setAccaStatus(a.id,"lost")));
      btnRow.appendChild(mkBtn("⚪", "void", ()=>setAccaStatus(a.id,"void")));
      btnRow.appendChild(mkBtn("🗑️", "del", ()=>removeAcca(a.id)));
...
const sections = [
  ...
  sectionsToShow.forEach(sec=>{
    ...
    rows.forEach(t=>{
      ...
      btnRow.appendChild(mkBtn("✅", "win", ()=>setTrackerStatus(t.id,"won")));
      btnRow.appendChild(mkBtn("❌", "lose", ()=>setTrackerStatus(t.id,"lost")));
      btnRow.appendChild(mkBtn("⚪", "void", ()=>setTrackerStatus(t.id,"void")));
      btnRow.appendChild(mkBtn("📋", "copy", async ()=>{ const ok = await copyText(betSlipLine(t)); alert(ok ? "Copied ✅" : "Copy failed"); }));
      btnRow.appendChild(mkBtn("🗑️", "del", ()=>removeTracker(t.id)));
